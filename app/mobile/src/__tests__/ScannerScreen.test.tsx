...
describe('ScannerScreen QR parsing', () => {
  it('extracts aidId from app deep link', () => {
    expect(parseAidIdFromQRCode('chainforge://package/aid-123')).toBe('aid-123');
  });

  it('extracts aidId from testnet URL', () => {
    expect(parseAidIdFromQRCode('https://testnet.chainforge.app/package/aid-456')).toBe('aid-456');
  });
